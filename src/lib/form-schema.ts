...
export const jobFormSchema = z.object({
    ...
    responsibility: z.string({required_error: 'Responsibilities is required'}).min(10, {message: 'Responsibilities must be at least 10 characters long'}),
    ...
    }).array().nonempty({message: 'You need to select at least 1 benefit'})
})
