...
export const JOB_LISTING_COLUMS:string[] =['Roles', 'Status','Date Posted','Due Date', 'Job Type', 'Applicants', 'Needs'];

export const JOB_APPLICANTS_COLUMS:string[] =['Name', 'Applied Date'];
